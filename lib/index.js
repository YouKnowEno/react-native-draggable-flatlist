...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.flingGestureHandlerRef = react_1.default.createRef();
    ...
    _this._onHorizontalFlingHandlerStateChange = function(event) {
      if (
    ...
    _this.onHorizontalSwipeStageChangeTester1 = function(event) {
      if (
        event.nativeEvent.state ===
        react_native_gesture_handler_1.State.UNDETERMINED
      ) {
    ...
    _this.onHorizontalSwipeStageChangeTester2 = function(event) {
      if (
        event.nativeEvent.state ===
        react_native_gesture_handler_1.State.UNDETERMINED
      ) {
    ...
    console.log(_this.panGestureHandlerRef);
    console.log("panGestureHandlerRef2:");
    console.log(_this.panGestureHandlerRef2);
