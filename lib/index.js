...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.hoverAnimUnconstrained = sub(
      sub(_this.dragTouchAbsolute, _this.activationDistance),
        ...
        nativeEvent: function(_a) {
          ...
          return cond(neq(state, _this.horizontalSwipeGestureState), [
            ...
            cond(
              ...
              [
                set(_this.hsTouchAbsolute, _this.props.horizontal ? x : y),
            ...
            cond(eq(state, react_native_gesture_handler_1.State.ACTIVE), [
              ...
              set(
                _this.activationDistance,
                sub(_this.props.horizontal ? x : y, _this.hsTouchInit)
              ),
              // Assigns y value to hsTouchAbsolute
              set(_this.hsTouchAbsolute, _this.props.horizontal ? x : y)
            ]),
          ...
          react_1.default.createElement(
            ...
            function() {
              return block([
                onChange(
                  _this.activationDistance,
                  call([_this.activationDistance], function(_a) {
                    var activationDistance = _a[0];
