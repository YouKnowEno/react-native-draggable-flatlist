...
var DraggableFlatList = /** @class */ (function(_super) {
  ...
  function DraggableFlatList(props) {
    ...
    _this.horizFlatListRef = _this.props.horizFlatListRef;
        ...
        nativeEvent: function(_a) {
          ...
          return cond(neq(state, _this.horizontalSwipeGestureState), [
            ...
            cond(eq(state, react_native_gesture_handler_1.State.ACTIVE), [
              set(_this.hsTouchAbsolute, x),
              call([], function(_a) {
                _this.isHorizontalSwiping.js = true;
                // console.log(
            ...
            cond(
              ...
              call([], function() {
                ...
                _this.isHorizontalSwiping.js = false;
                // console.log(
                //   "horizontalSwiping.js: " + this.isHorizontalSwiping.js
                // );
              })
    ...
    _this.onHorizontalSwipeEvent = event([
      {
        ...
        nativeEvent: function(_a) {
          ...
          return cond(
            and(
              neq(_this.isPressedIn.native, 1),
              eq(
                _this.horizontalSwipeGestureState,
                react_native_gesture_handler_1.State.ACTIVE
              )
    ...
    var data = props.data,
      onRef = props.onRef,
      onPanRef = props.onPanRef,
      horizFlatListRef = props.horizFlatListRef;
    ...
    onPanRef && onPanRef(_this.draggableHandlerRef);
    return _this;
  }
