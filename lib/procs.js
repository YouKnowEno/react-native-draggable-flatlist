...
exports.getCellStart = proc(function(
  isAfterActive,
  offset,
  activeCellSize,
  scrollOffset
  ...
  return sub(
    cond(isAfterActive, sub(offset, activeCellSize), offset),
    scrollOffset
  );
});
exports.getOnChangeTranslate = proc(function(
  translate,
  isAfterActive,
  initialized,
  toValue,
...
exports.setupCell = proc(function(
  currentIndex,
  initialized,
  size,
  offset,
